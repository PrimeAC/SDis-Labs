...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="hello-ws-cli_handlers_relay" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" example.ws.cli.HelloClient %CMD_LINE_ARGS%
