...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="echo-ws-cli_async" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" example.ws.cli.EchoClientMain %CMD_LINE_ARGS%
